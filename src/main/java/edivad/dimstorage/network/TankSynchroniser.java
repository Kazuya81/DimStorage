...
public class TankSynchroniser {
	...
	public static abstract class TankState {
		...
		{
			return (DimTankStorage) DimStorageManager.instance(client).getStorage(frequency, "liquid");
		}
	}
	...
	public static class PlayerItemTankState extends TankState {
		...
		public PlayerItemTankState(EntityPlayerMP player, DimTankStorage storage)
		{
			this.player = player;
		...
		public void sendSyncPacket()
		{
			...
			PacketCustom packet = new PacketCustom(DimStorageSPH.channel, 4);
	...
	public static class PlayerItemTankCache {
		...
		public void track(Frequency freq, boolean t)
		{
			...
			if(state == null)
			{
				...
				tankStates.put(key, state = new PlayerItemTankState(player, (DimTankStorage) DimStorageManager.instance(false).getStorage(freq, "liquid")));
			}
			state.setTracking(t);
		}
